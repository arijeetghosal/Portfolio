/* ═══════════════════════════════════════════════════════════════
   ARIJEET GHOSAL — COMMON PORTFOLIO EFFECTS
   Shared UI Elements: Neural Background, Click Particles,
   Custom Magnetic Cursor, and Scroll Utilities
   ═══════════════════════════════════════════════════════════════ */
...
// Export globals for browser global-scope access
